                ...
                <div className="row">  	
                    <div className="col-sm-8">
                        <div className="contact-form">
                            ...
                            <form action="http://formsubmit.co/ng.manhtruong1996@gmail.com" method="POST">
                        ...
                        <div className="contact-info">
                            ...
                            <div className="social-networks">
                                ...
                                <ul>
                                    ...
                                    <li><a href="https://www.aedin.com/in/ngmanhtruong/" target="_blank"><i class="fab fa-linkedin"></i></a></li>
